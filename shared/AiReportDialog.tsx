                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-[13px] text-ink-soft">
                      {t({
                        ru: "ИИ-помощник классифицирует обращение и направит в нужное ведомство",
                        kk: "ЖИ-көмекші өтінішті жіктеп, тиісті ведомствоға жолдайды",
                      })}
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-5 px-5 py-5 sm:px-6">
                    ...
                    <div>
                      <label htmlFor="ai-message" className="section-label mb-2.5 block">
                        {t({ ru: "Описание проблемы", kk: "Мәселенің сипаттамасы" })}
                      </label>
                      <textarea
                        id="ai-message"
                        ref={textareaRef}
                        ...
                        placeholder={t({
                          ru: "Опишите проблему — ИИ определит категорию и приоритет…",
                          kk: "Мәселені сипаттаңыз — ЖИ санат пен басымдықты анықтайды…",
                        })}
                        rows={4}
                        maxLength={500}
                        disabled={status === "sending"}
                      ...
                      <div className="mt-1.5 flex items-center justify-between text-[11px] text-ink-faint">
                        <span>{t({ ru: "Минимум 10 символов", kk: "Кемінде 10 таңба" })}</span>
                    ...
                    <div>
                      <label htmlFor="ai-address" className="section-label mb-2.5 block">
                        {t({ ru: "Адрес или ориентир", kk: "Мекенжай немесе бағдар" })}
                      </label>
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder={t({ ru: "г. Кокшетау, ул. …", kk: "Көкшетау қ., … к-сі" })}
                          disabled={status === "sending"}
                    ...
                    {/* Quick prompts */}
                    <div>
                      <p className="section-label mb-2.5">{t({ ru: "Быстрые шаблоны", kk: "Жылдам үлгілер" })}</p>
                      <motion.div
                      ...
                      >
                        {status === "sending" ? (
                          <>
                            ...
                            />
                            {t({ ru: "Отправка…", kk: "Жіберілуде…" })}
                          </>
                        ) : (
                          <>
                            {t({ ru: "Отправить", kk: "Жіберу" })}
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-5 text-xl font-extrabold text-ink">
        {t({ ru: "Обращение принято", kk: "Өтініш қабылданды" })}
      </h3>
      <p className="mt-2 max-w-xs text-[14px] leading-relaxed text-ink-soft">
        {t({
          ru: "ИИ обрабатывает ваше сообщение. Номер заявки и статус придут в течение нескольких минут.",
          kk: "ЖИ хабарламаңызды өңдеуде. Өтінім нөмірі мен мәртебесі бірнеше минут ішінде келеді.",
        })}
      </p>
      <div className="mt-6 w-full rounded-xl border border-line bg-page/50 px-4 py-3">
        <div className="font-mono text-[11px] tracking-wide text-ink-faint">
          {t({ ru: "НОМЕР ОБРАЩЕНИЯ", kk: "ӨТІНІШ НӨМІРІ" })}
        </div>
